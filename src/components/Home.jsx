...
import heroBg from '../../folder/hero-home-bg.jpg';
import { useLanguage } from '../contexts/LanguageContext';
import Layout from './Layout';

/**
 * Home component migrated from the legacy `folder/` directory.
 * Aside from path adjustments, contents are unchanged.
 */
const Home = () => {
  const { t } = useLanguage();
  ...
  return (
    <Layout>
      ...
      <section className="hero">
        <Image src={heroBg} alt="Algae cultivation facility" className="hero-bg" priority />
        <div className="hero-content fade-in-up">
          <h1 className="hero-title">{t('Oldest Plant, Newest Power.', 'Oldest Plant, Newest Power.')}</h1>
          <p className="hero-subtitle">{t('\"地球のはじまりの植物\"で世界を満たす。', "Filling the world with \"Earth's first plants\".")}</p>
      ...
      {/* 以下、元の Home.jsx コンテンツをそのまま保持 */}
      {/* マザーベジタブルセクション */}
      <section className="section">
        <div className="container">
          <div className="section-header">
            <h2 className="section-title">{t('What is Mother Vegetables?', 'What is Mother Vegetables?')}</h2>
          ...
          <div className="premium-grid premium-grid-2">
            <div className="premium-card premium-card-gradient-1 fade-in-up">
              ...
              <h3 className="premium-card-title">{t('30億年の歴史', '3 Billion Years of History')}</h3>
              <p className="premium-card-description">
                {t(
                  '30億年にわたり姿を保ち続けてきた、あらゆる生命の起源となる"地球のはじまりの植物たち"。マザーベジタブルは、食、美しさ、そして環境をも支える、未来の恵みです。',
                  "The \"Earth's first plants\" that have maintained their form for 3 billion years, the origin of all life. Mother Vegetables are future blessings that support food, beauty, and the environment."
                )}
              </p>
            </div>
            ...
            <div className="premium-card premium-card-gradient-2 fade-in-up">
              ...
              <h3 className="premium-card-title">{t('オーガニックな恵み', 'Organic Blessings')}</h3>
              <p className="premium-card-description">
                {t(
                  'あるものは食となり、あるものは美を整え、あるものは空気を浄化して地球を癒す。人と地球をケミカルから解き放ち、オーガニックな恵みで健やかさを育てながら、CO₂削減にも貢献します。',
                  'Some become food, some enhance beauty, and some purify the air to heal the Earth. Freeing people and the planet from chemicals, nurturing wellness with organic blessings while contributing to CO₂ reduction.'
                )}
              </p>
            </div>
          </div>
          ...
          <div className="premium-cta-section">
            <Link href="/mother-vegetables" className="btn btn-primary btn-premium">
              {t('詳細はこちら', 'Learn More')}
            </Link>
          </div>
        </div>
      ...
      <section className="section section-premium-alt">
        <div className="container">
          <div className="section-header">
            <h2 className="section-title">{t('What is MVファクトリー?', 'What is MV Factory?')}</h2>
            <p className="section-subtitle">
          ...
          <div className="premium-grid premium-grid-3">
            <div className="premium-card premium-card-elevated fade-in-up">
              ...
              <h3 className="premium-card-title">{t('国際特許取得済', 'International Patent Acquired')}</h3>
              <p className="premium-card-description">
            ...
            <div className="premium-card premium-card-elevated fade-in-up">
              ...
              <h3 className="premium-card-title">{t('30倍の育成スピード', '30x Growth Speed')}</h3>
              <p className="premium-card-description">
            ...
            <div className="premium-card premium-card-elevated fade-in-up">
              ...
              <h3 className="premium-card-title">{t('どこでも設置可能', 'Installable Anywhere')}</h3>
              <p className="premium-card-description">
          ...
          <div className="premium-cta-section">
            <Link href="/mv-factory" className="btn btn-primary btn-premium">
              {t('詳細はこちら', 'Learn More')}
            </Link>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            <h2 className="section-title">{t('サステナブルな取り組み', 'Sustainable Initiatives')}</h2>
            <p className="section-subtitle">{t('あなたの選択で、地球が蘇る。', 'Your choices revive the Earth.')}</p>
          </div>

          <div className="premium-grid premium-grid-2">
            <div className="premium-card premium-card-sustainable-1 fade-in-up">
              <div className="premium-card-highlight">700x</div>
              <h3 className="premium-card-title">{t('天然芝の700倍のCO₂吸収', '700x CO₂ Absorption vs Natural Grass')}</h3>
              <p className="premium-card-description">
            ...
            <div className="premium-card premium-card-sustainable-2 fade-in-up">
              ...
              <h3 className="premium-card-title">{t('廃棄ゼロの循環システム', 'Zero-Waste Circular System')}</h3>
              <p className="premium-card-description">
          ...
          <div className="premium-cta-section">
            <Link href="/sustainable-vision" className="btn btn-primary btn-premium">
              {t('詳細はこちら', 'Learn More')}
            </Link>
          </div>
        </div>
